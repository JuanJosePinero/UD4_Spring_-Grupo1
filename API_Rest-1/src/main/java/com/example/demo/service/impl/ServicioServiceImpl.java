...
public class ServicioServiceImpl implements ServicioService {
	...
	public Servicio updateServicio(ServicioModel servicioModel) {
		...
		if (servicio != null) {
			...
			if (servicioModel.getFinished() != -1 || servicioModel.getFinished() != 0
					|| servicioModel.getFinished() != 1) {
	...
	public List<ServicioModel> findServiciosByProFamily(String familyName) {
		...
		for (Servicio servicio : servicioRepository.findAll()) {
			if (servicio.getProfesionalFamilyId() != null
	...
	public Servicio getOneServiceByBusinessId(Business business, String title, String description) {
		...
		if (existingServicios != null && !existingServicios.isEmpty()) {
			for (Servicio existingServicio : existingServicios) {
				if (existingServicio.getTitle().equals(title) && existingServicio.getDescription().equals(description)) {
